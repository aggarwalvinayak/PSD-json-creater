...
data={}
students=list()
head=["Company","City","IndustryDomain","stipend","Tags","Proj1","Proj2","Proj3","Proj4","Proj5","Proj6","Proj7"]
students.append(head)
FILE_PATH = "/home/vinayak/Downloads/full (2).json"
	...
	for j in i["projs"]:
		if(j["BatchName"]=="2020-2021 / SEM-I"):
			...
			for proj in j["details"]:
				try:
					temp.append(proj["projectTitle"]+" -> "+proj["PBDescription"] +" >>>SKILLS<<< = "+ proj["SKills"])
				except:
					try:
